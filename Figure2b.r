...
workdir <- "."
datafile <- file.path(workdir,"Figure_obesity_yes_medication.csv")
...
forestplot(labeltext=tabletext, 
        ...
        title ="Medication prescriptions related to suicidal ideations treatment in patients with overweight or obesity \nwithin 6-month follow-up time window\n(comparison between propensity-score matched groups)", 
