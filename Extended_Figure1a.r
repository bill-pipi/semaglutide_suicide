...
workdir <- "."
datafile <- file.path(workdir,"Figure_t2d_yes_diagnosis.csv")
...
pdf(file.path(workdir,"Extended_Figure1a.pdf"),  onefile=FALSE, width=10, height=5.5)
